  ...
  return (
    <Stack>
      ...
      <Container>
        ...
        <Typography variant="h6">La meilleure application du marché</Typography>
        <Typography variant="body1">Louison LEIDINGER</Typography>
        <Typography variant="caption">
          Ma nourriture est arrivée en 5 minutes, alors que le restaurant se
          trouve à 3 heures de chez moi.
        </Typography>
        <Divider variant="middle" />
        <Rating name="" value={5} readOnly sx={{ marginTop: "5px" }} />
        ...
        <Typography variant="caption">
          Livraison au top, en plus les frais sont vraiment insignifiants
          comparés à la concurrence.
        </Typography>
        <Divider variant="middle" />
        ...
        <Typography variant="caption">
          Livraison rapide, pas besoin d'aller au Burger King car la commande
          est jamais arrivée.
        </Typography>
      </Container>
    </Stack>
