...
import { emptyCart } from "../../../store/reducers/order";
...
function CartTitle() {
  ...
  const handleAddOrder = async () => {
    const response = await addOrder(orderCart.restaurant._id!, orderCart.price, orderCart.restaurant.name, orderCart.restaurant.address, orderCart.restaurant.telephone, orderCart.restaurant.idAccount!);
